 ...
 * @param {*} forceAnimate 
 */
function calculateParams(animator, easing$$1, oneTrackDone, keyframes, propName, forceAnimate) {
    var getter = animator._getter;
    var setter = animator._setter;
    var useSpline = easing$$1 === 'spline';
...
function Clip(animator, easing$$1, oneTrackDone, keyframes, propName, forceAnimate) {
    let options=calculateParams(animator, easing$$1, oneTrackDone, keyframes, propName, forceAnimate);
    if(!options){
        return null;
    }
